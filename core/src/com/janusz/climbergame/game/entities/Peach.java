...
{
    public Peach(PlayGameState pgs, int starting_x, int velocity)
    {
        super(pgs, EntityTextures.get().peach,starting_x, velocity);
        this.setName("good");
        bounds = new Rectangle(starting_x, ClimberGame.HEIGHT,
                Const.PEACH_WIDTH, Const.PEACH_HEIGHT);
        this.setSize(Const.PEACH_WIDTH, Const.PEACH_HEIGHT);
